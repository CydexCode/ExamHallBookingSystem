...
export default function New(props) {
    ...
    return (
        <div className="modal-container">
            <div className="modal-title" >MID/QUIZ BOOKING FORM</div>
<br></br>
            <div className="mt-15">
 ...
 <div className="form-container">
    <div className="form-row">
        <div className="form-field">
            ...
            <input type="text" id="Num_of_Student" maxLength="2" name="numOfStudent" onChange={newApp} />
        </div>
...
<br></br>
            ...
            <div className="row justify-btw modal-action-container mt-15">
                <div className="btn" onClick={() => closeModal("new-modal")}>Confirm</div>
                <div className="btn" onClick={postApp}>Add to Calender</div>
            </div>
        </div>
    )
}