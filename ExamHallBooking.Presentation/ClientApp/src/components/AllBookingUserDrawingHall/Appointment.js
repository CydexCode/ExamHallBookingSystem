...
export default function AppointmentDrawingHall(props) {
    ...
    const levelOfImportance = ["End Exam", "Mid Exam", "Quiz", "Assignment", "", ""];
    return (
        <tr>
            ...
            <td className={`column importance ${props.item.levelOfImportance === 1 ? ' bc-green' :
                props.item.levelOfImportance === 2 ? ' bc-gold' :
                props.item.levelOfImportance === 0 ? ' bc-red' :
                props.item.levelOfImportance === 3 ? ' bc-blue' : ''}`}>
