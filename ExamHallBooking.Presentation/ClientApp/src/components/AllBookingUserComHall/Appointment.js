...
export default function Appointment(props) {
    ...
    return (
        <tr>
                    ...
                    <td class={`column importance ${props.item.levelOfImportance === 1 ? ' bc-green' : 
            props.item.levelOfImportance === 2 ? ' bc-gold' : props.item.levelOfImportance === 0 ? ' bc-red' : props.item.levelOfImportance === 3 ? ' bc-blue': ''}`}> {levelOfImportance[props.item.levelOfImportance]}</td>
